...
#
#
def transform_station(stationEvent):
    stationEvent.station_id = stationEvent.station_id
    stationEvent.station_name= stationEvent.station_name
    stationEvent.order = stationEvent.order
    if stationEvent.red:
        stationEvent.line = "red"
    elif stationEvent.blue:
        stationEvent.line = "blue"
    elif stationEvent.green:
        stationEvent.line = "green"
    return stationEvent
...
async def stationevent(stationevents):
    ...
    #
    stationevents.add_processor(transform_station)
    async for station in stationevents:
        await out_topic.send(key=station.station_id, value=station)
